...
- The root page loads the standalone Instance Enrollment form with controller API key, instance name, and instance URL fields; no OAuth sign-in is presented.
